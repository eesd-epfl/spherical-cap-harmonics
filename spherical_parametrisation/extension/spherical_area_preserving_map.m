function map = spherical_area_preserving_map(v,f)
% A linear method for computing spherical area-preserving map of a genus-0 closed surface 
%
% Remark: 
% This code is a simple variation of spherical_conformal_map. Here we 
% replace the cotangent Laplacian by the locally authalic Laplacian. 
% Note that this approach aims to reduce the local area distortion, while 
% the global area distortion is not necessarily minimized.
% This code can be used as an initialization in iterative_spherical_area_preserving_map
% for further reducing the local area distortion.
%
% Input:
